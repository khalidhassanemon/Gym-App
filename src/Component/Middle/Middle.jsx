    ...
    <div className="ml-36 mr-36">
      <div className="row mb-10">
        <div className="col-sm-6 mb-3 mb-sm-0">
          <div className="card ">
            <div className="card-body bg-gradient-to-l from-indigo-500">
              <h5 className="card-title text-2xl font-sans ">
        ...
        <div className="col-sm-6">
          <div className="card">
            <div className="card-body bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100">
              <p className="card-text text-gray-500 text-sm text-justify ">
